...
public class Bai5 extends JFrame {
	...
	public void addControl() {
		...
		final JTextField txta = new JTextField(20);
		pna.add(lbla);
		pna.add(txta);
		pnCenter.add(pna);
		...
		final JTextField txtb = new JTextField(20);
		pnb.add(lblb);
		pnb.add(txtb);
		pnCenter.add(pnb);
		...
		final JTextField txtc = new JTextField(20);
		pnc.add(lblc);
		pnc.add(txtc);
		pnCenter.add(pnc);
		...
		final JTextField txtketqua = new JTextField(20);
		...
		btnGiai.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (a == 0) {
					nghiem = (double) (-c / b);
					txtketqua.setText("nghiem=" + nghiem);
				} else {
					...
					if (delta < 0) {
						...
						txtketqua.setText("PT có 2 nghiệm PB: " + "x1=" + x1 + " && " + "x2=" + x2);
					}
				}
			}
		});
